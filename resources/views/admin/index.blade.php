...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="/admin/head"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="/admin/left" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="/img/indexBanner.png" name="main" scrolling="yes" noresize="noresize"
